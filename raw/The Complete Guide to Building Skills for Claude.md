...
published:
created: 2026-04-19
description: The Complete Guide to Building Skills for Claude
tags:
---
...
*Real example:* [frontend-design skill](https://claude.ai) (also see skills for [docx](https://claude.ai), [pptx](https://claude.ai), [xlsx](https://claude.ai), and [ppt](https://claude.ai))
...
*Real example:* [skill-creator skill](https://claude.ai)
...
*Real example:* [sentry-code-review skill (from Sentry)](https://claude.ai)
...
According to Anthropic's [engineering blog](https://www.anthropic.com): "This metadata...provides just enough information for Claude to know when each skill should be used without loading all of it into context." This is the first level of progressive disclosure.
...
- [Skills in the Agent SDK](https://docs.anthropic.com)
...
**Advanced technique:** For critical validations, consider bundling a script that performs the checks programmatically rather than relying on language instructions. Code is deterministic; language interpretation isn't. See the [Office skills](https://claude.ai) for examples of this pattern.
...
- [Introducing Agent Skills](https://www.anthropic.com)
- [Engineering Blog: Equipping Agents for the Real World](https://www.anthropic.com)
- [Skills Explained](https://www.anthropic.com)
- [How to Create Skills for Claude](https://www.anthropic.com)
- [Building Skills for Claude Code](https://www.anthropic.com)
- [Improving Frontend Design through Skills](https://www.anthropic.com)
...
- General questions: Community forums at the [Claude Developers Discord](https://discord.gg/claude-dev)
...
- **Document Skills** — [PDF](https://github.com/anthropics/skills), [DOCX](https://github.com/anthropics/skills), [PPTX](https://github.com/anthropics/skills), [XLSX](https://github.com/anthropics/skills) creation

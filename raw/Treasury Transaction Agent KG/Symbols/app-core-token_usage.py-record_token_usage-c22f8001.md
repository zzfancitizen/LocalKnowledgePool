---
title: "record_token_usage"
tags:
  - treasury-agent/symbol
  - understand-anything
node_type: "function"
node_id: "function:app/core/token_usage.py:record_token_usage"
source_path: "app/core/token_usage.py"
---

# record_token_usage

record_token_usage 是 token_usage.py 中的函数，封装该文件在 核心基础设施 场景下的一段可复用处理逻辑。
...
- calls -> [[Treasury Transaction Agent KG/Symbols/app-core-token_usage.py-merge_usage-a86ee15a|app/core/token_usage.py]]

...
tags:
  ...
  - understand-anything
node_type: "function"
node_id: "function:tests/providers/mcp/test_tool_factory_multi_server.py:_list_schema"
source_path: "tests/providers/mcp/test_tool_factory_multi_server.py"
---

# _list_schema

_list_schema 是 test_tool_factory_multi_server.py 中的函数，封装该文件在 测试 场景下的一段可复用处理逻辑。

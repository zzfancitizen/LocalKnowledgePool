...
tags:
  ...
  - understand-anything
node_type: "function"
node_id: "function:app/core/token_usage.py:merge_usage"
source_path: "app/core/token_usage.py"
---

# merge_usage

merge_usage 是 token_usage.py 中的函数，封装该文件在 核心基础设施 场景下的一段可复用处理逻辑。
...
- [[Treasury Transaction Agent KG/Symbols/app-core-token_usage.py-record_token_usage-c22f8001|app/core/token_usage.py]] -> calls

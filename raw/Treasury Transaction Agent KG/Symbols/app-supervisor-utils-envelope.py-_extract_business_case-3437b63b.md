---
title: "_extract_business_case"
tags:
  - treasury-agent/symbol
  - understand-anything
node_type: "function"
node_id: "function:app/supervisor/utils/envelope.py:_extract_business_case"
source_path: "app/supervisor/utils/envelope.py"
---

# _extract_business_case

_extract_business_case 是 envelope.py 中的函数，封装该文件在 Supervisor 编排 场景下的一段可复用处理逻辑。

---
title: "_extract_condition_rate"
tags:
  - treasury-agent/symbol
  - understand-anything
node_type: "function"
node_id: "function:app/changer/utils/odata_transform.py:_extract_condition_rate"
source_path: "app/changer/utils/odata_transform.py"
---

# _extract_condition_rate

_extract_condition_rate 是 odata_transform.py 中的函数，封装该文件在 Changer 执行 场景下的一段可复用处理逻辑。
...
- [[Treasury Transaction Agent KG/Symbols/app-changer-utils-odata_transform.py-transform_instrument_details-fd9a6f9e|app/changer/utils/odata_transform.py]] -> calls

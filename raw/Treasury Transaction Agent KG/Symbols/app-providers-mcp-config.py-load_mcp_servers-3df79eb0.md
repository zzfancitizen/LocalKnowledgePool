---
title: "load_mcp_servers"
tags:
  - treasury-agent/symbol
  - understand-anything
node_type: "function"
node_id: "function:app/providers/mcp/config.py:load_mcp_servers"
source_path: "app/providers/mcp/config.py"
---

# load_mcp_servers

load_mcp_servers 是 config.py 中的函数，封装该文件在 项目支撑 场景下的一段可复用处理逻辑。
...
- calls -> [[Treasury Transaction Agent KG/Symbols/app-providers-mcp-config.py-load_mcp_overrides-c2d26eff|app/providers/mcp/config.py]]

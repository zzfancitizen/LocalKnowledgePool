---
title: "get_current_llm_call_count"
tags:
  - treasury-agent/symbol
  - understand-anything
node_type: "function"
node_id: "function:app/core/token_usage.py:get_current_llm_call_count"
source_path: "app/core/token_usage.py"
---

# get_current_llm_call_count

get_current_llm_call_count 是 token_usage.py 中的函数，封装该文件在 核心基础设施 场景下的一段可复用处理逻辑。

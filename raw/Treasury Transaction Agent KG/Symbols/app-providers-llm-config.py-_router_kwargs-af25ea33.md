---
title: "_router_kwargs"
tags:
  - treasury-agent/symbol
  - understand-anything
node_type: "function"
node_id: "function:app/providers/llm/config.py:_router_kwargs"
source_path: "app/providers/llm/config.py"
---

# _router_kwargs

_router_kwargs 是 config.py 中的函数，封装该文件在 项目支撑 场景下的一段可复用处理逻辑。
...
- [[Treasury Transaction Agent KG/Symbols/app-providers-llm-config.py-_parse_yaml-c9e3c525|app/providers/llm/config.py]] -> calls

---
title: "_GlobalUsageAccumulator"
tags:
  - treasury-agent/symbol
  - understand-anything
node_type: "class"
node_id: "class:app/core/token_usage.py:_GlobalUsageAccumulator"
source_path: "app/core/token_usage.py"
---

# _GlobalUsageAccumulator

_GlobalUsageAccumulator 是 token_usage.py 中的类，组织 核心基础设施 相关状态与行为，包含 4 个方法。

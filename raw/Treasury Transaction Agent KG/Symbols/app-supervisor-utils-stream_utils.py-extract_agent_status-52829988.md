---
title: "extract_agent_status"
tags:
  - treasury-agent/symbol
  - understand-anything
node_type: "function"
node_id: "function:app/supervisor/utils/stream_utils.py:extract_agent_status"
source_path: "app/supervisor/utils/stream_utils.py"
---

# extract_agent_status

extract_agent_status 是 stream_utils.py 中的函数，封装该文件在 Supervisor 编排 场景下的一段可复用处理逻辑。

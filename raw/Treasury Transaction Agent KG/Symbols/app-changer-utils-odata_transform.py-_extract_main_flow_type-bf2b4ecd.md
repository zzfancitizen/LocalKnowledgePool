---
title: "_extract_main_flow_type"
tags:
  - treasury-agent/symbol
  - understand-anything
node_type: "function"
node_id: "function:app/changer/utils/odata_transform.py:_extract_main_flow_type"
source_path: "app/changer/utils/odata_transform.py"
---

# _extract_main_flow_type

_extract_main_flow_type 是 odata_transform.py 中的函数，封装该文件在 Changer 执行 场景下的一段可复用处理逻辑。

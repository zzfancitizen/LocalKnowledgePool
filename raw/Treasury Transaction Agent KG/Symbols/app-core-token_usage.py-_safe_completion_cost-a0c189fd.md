---
title: "_safe_completion_cost"
tags:
  - treasury-agent/symbol
  - understand-anything
node_type: "function"
node_id: "function:app/core/token_usage.py:_safe_completion_cost"
source_path: "app/core/token_usage.py"
---

# _safe_completion_cost

_safe_completion_cost 是 token_usage.py 中的函数，封装该文件在 核心基础设施 场景下的一段可复用处理逻辑。
...
- [[Treasury Transaction Agent KG/Symbols/app-core-token_usage.py-extract_token_usage-47e3a02a|app/core/token_usage.py]] -> calls

---
title: "_resolve_max_tokens"
tags:
  - treasury-agent/symbol
  - understand-anything
node_type: "function"
node_id: "function:app/core/message_trim.py:_resolve_max_tokens"
source_path: "app/core/message_trim.py"
---

# _resolve_max_tokens

_resolve_max_tokens 是 message_trim.py 中的函数，封装该文件在 核心基础设施 场景下的一段可复用处理逻辑。
...
- [[Treasury Transaction Agent KG/Symbols/app-core-message_trim.py-trim_for_llm-b01c2662|app/core/message_trim.py]] -> calls

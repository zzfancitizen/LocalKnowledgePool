---
title: "_truncate_tool_calls"
tags:
  - treasury-agent/symbol
  - understand-anything
node_type: "function"
node_id: "function:app/plugins/agent_memory/message_converter.py:_truncate_tool_calls"
source_path: "app/plugins/agent_memory/message_converter.py"
---

# _truncate_tool_calls

_truncate_tool_calls 是 message_converter.py 中的函数，封装该文件在 插件系统 场景下的一段可复用处理逻辑。
...
- [[Treasury Transaction Agent KG/Symbols/app-plugins-agent_memory-message_converter.py-langchain_to_odata-6281cd16|app/plugins/agent_memory/message_converter.py]] -> calls
